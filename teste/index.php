...
<body>
	<?php
		...
		$sessao_id = PagSeguro::getSessionCode()->getResult();
	?>
    <script>   
	...
	<button onClick="gerarToken()">Gerar Hash e Token</button>
		...
		<input type="text" name="pedido_id" id="pedido_id" value="Listamed">
		</br>
                <label>Url de retorno</label>
		<input type="text" name="url_retorno" id="url_retorno" value="https://listamed.com.br/teste/retorno.php?pedido_id=123">
		</br>
		...
		<input type="text" name="cobranca_estado" id="cobranca_estado" value="RS">
                ...
                <input type="text" name="produto_descricao" id="produto_descricao" value="Listamed">
                </br>
                ...
                <input type="text" name="produto_valor" id="produto_valor" value="1">
                </br>
