            ...
            <footer class="row page-footer page-footer--position" id="footer">
                <div class="row page-footer--cinza">
                    <div class="container center">
                        ...
                        <div class="text-center mobile-show tablet-show notebook-hide">
                            <nav class="nav-footer">
                                <ul>
                                    <li><a href="<?php echo $caminho; ?>sobre">Sobre a ListaMed</a></li>
                ...
                <div class="row page-footer--branco">
                    <div class="container center">
                        <div class="col-lg-1 col-sm-2">
                            <a href="<?php echo $caminho; ?>"><img src="<?php echo $caminho?>images/logo-internas-bot.png" /></a>
                        </div>
                ...
                <div class="row page-footer--escuro">
                    <div class="container center">
                        <div class="col-lg-4 page-footer--copyright mobile-hide tablet-hide notebook-show desktop-show">
                            <p>TODOS OS DIREITOS RESERVADOS - LISTAMED <?php echo date('Y'); ?> ®</p>
                        </div>
                        <div class="col-lg-3 page-footer--copyright center mobile-show tablet-show notebook-hide desktop-hide">
                            <p>TODOS OS DIREITOS RESERVADOS - LISTAMED <?php echo date('Y'); ?> ®</p>
                        </div>
                        <div class="right page-footer--dev mobile-hide tablet-hide notebook-show desktop-show">
                            <p>Feito por
                                <a href="http://www.wdezoito.com.br/" target="_blank"><img src="/images/logo-w18.png" /></a>
                            </p>
                        </div>
                        <div class="page-footer--dev center mobile-show tablet-show notebook-hide desktop-hide col-lg-2">
                            <p>Feito por
                                <a href="http://www.wdezoito.com.br/" target="_blank"><img src="/images/logo-w18.png" /></a>
                            </p>
                        </div>
