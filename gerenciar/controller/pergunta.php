...
class PerguntaController extends ControllerAbstract {
     ...
     */
    function pergunta_save($metodo=null)
    {
        $op = null;
    ...
    public function pergunta_delete($id)
    {
        try {
            $sql = "DELETE FROM tb_perguntasfrequentes WHERE id = :id";
